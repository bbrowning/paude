...
class OpenClawAgent:
    ...
    def __init__(self, provider: str | None = None) -> None:
        ...
        self._config = AgentConfig(
            ...
            # openclaw.json embeds the gateway auth token; strip it from backups.
            # It is regenerated by apply_sandbox_config on the next start.
            credential_file_names=[".openclaw/openclaw.json"],
            activity_files=[],
            yolo_flag=None,
            clear_command=None,
