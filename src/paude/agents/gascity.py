...
class GascityAgent:
    ...
    GeminiAgent and composed into the image via get_agents() +
    compose_dockerfile_install_lines(). This agent's own Dockerfile lines cover
    only the Gas City core: gc, dolt, bd, and the Node.js prerequisite.
    """
